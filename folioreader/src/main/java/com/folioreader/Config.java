...
public class Config implements Parcelable {
    ...
    public static final String CONFIG_IS_RTL = "is_rtl";
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        bundle.putBoolean(CONFIG_IS_RTL, isRtl);
    ...
    protected Config(Parcel in) {
        try {
            ...
            if (bundle == null) {
                ...
                isRtl = getBundleItem(bundle, CONFIG_IS_RTL, isRtl);
    ...
    public Config(JSONObject obj) {
        ...
        isRtl = getJsonItem(obj, CONFIG_IS_RTL, false);
        allowedDirection = getAllowedDirectionFromString(
                LOG_TAG,
    ...
    public Config setIsRtl(boolean isRtl) {
        this.isRtl = isRtl;
        return this;
    }
